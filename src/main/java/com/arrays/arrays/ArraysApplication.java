...
import com.arrays.arrays.repository.ServerRepository;

@SpringBootApplication
public class ArraysApplication {

	private static final String UrlBasedCorsConfigurationSource = null;
	...
	CommandLineRunner run(ServerRepository serverRepository) {
		return args -> {
			...
			serverRepository.save(new Server(null, "192.168.1.58", "Fedora", "16 GB", "Dell Tower", 
					"http://localhost:8080/server/image/server2.png", Status.SERVER_DOWN));
			
			serverRepository.save(new Server(null, "192.168.1.21", "MS 2008", "16 GB", "web Server", 
